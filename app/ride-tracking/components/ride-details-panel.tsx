              ...
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {/* Somebody to call.
                      *
                      * The whole point of following a shared trip is being
                      * able to act if it stops looking right, and the page
                      * gave you a name, a face, a plate and no way to reach
                      * anyone. A tel: link so it dials from the phone the
                      * link was opened on, which is where these are read. */}
                    {apiData.driver_phone && (
                      <a
                        href={`tel:${apiData.driver_phone}`}
