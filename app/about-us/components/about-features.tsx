...
const AboutFeatures = () => {
  return (
    <section className='brand-width '>
        ...
        <div className='mt-20 grid grid-cols-1 overflow-hidden place-content-center  place-items-center sm:grid-cols-2 lg:grid-cols-3 gap-4 '>
            {aboutfeatures.map((feature) => (
                <div key={feature.imageUrl} className={`bg-[${feature.backgroundColor}] flex flex-col justify-center items-center mb-12 max-w-[386px] min-h-[404.79998779296875px] mt-20 relative p-[23px] md:p-[33px] rounded-[14.26px] md:rounded-[20px]`}>
